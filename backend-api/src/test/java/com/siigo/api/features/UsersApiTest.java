...
import com.siigo.api.tasks.DeleteUser;
import com.siigo.api.tasks.GetUsers;
import com.siigo.api.tasks.UpdateUser;
...
public class UsersApiTest {
    ...
    public void updateUserTest() {
        ...
        User updatedUser = User.anUser()
                .withName("Edison Updated")
                .andJob("Senior QA Automation")
                .build();

        // Act
        edison.attemptsTo(
                UpdateUser.withInfo(1, updatedUser)
        );
